...
exports.handler = async (event) => {
    ...
    try {
        const query = `
            ...
            WHERE 
                b.accepted = false AND b.cancelled = false AND b.completed = false AND (b.challenger_id = $1 OR b.acceptor_id = $1 OR b.referee_id = $1)
        `;
        ...
        console.error('Error querying pending bouts:', err);
        return {
            statusCode: 500,
            body: JSON.stringify({ error: 'Failed to retrieve pending bouts' }),
        };
    }
};
